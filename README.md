...
<p align="center">
  ...
  <h3 align="center">Recipe App Mobile (Mama Recipe)</h3>
  <p align="center">
    <image align="center" width="200" src='https://github.com/Ihlassul2023/recipe-app-client/blob/main/src/assets/images/loading.png' />
  </p>
...
```sh
https://github.com/Ihlassul2023/recipeApp-mobile
```
...
4.then run the project with the following command
...
| ---------------------------------------------------------------- | ------------------------------------------------------------------------- |
| ![Login](/src/assets/screenshot/login.jpg?raw=true 'Login Page') | ![Register](/src/assets/screenshot/register.jpg?raw=true 'Register Page') |

| Home Page                                                           | Search Page                                                                     |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| ![Landing](/src/assets/screenshot/home.jpg?raw=true 'Landing Page') | ![Search Page](/src/assets/screenshot/search.jpg?raw=true 'Recipe Detail Page') |

| Detail Recipe Page                                                                      | Profile Page                                                                |
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| ![Detail Recipe](/src/assets/screenshot/detailRecipe.jpg?raw=true 'Detail Recipe Page') | ![Profile Page](/src/assets/screenshot/profile.jpg?raw=true 'Profile Page') |

| Add Recipe Page                                                                 | List Recipe Page                                                                 |
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| ![Add Recipe](/src//assets/screenshot/addRecipe.jpg?raw=true 'add Recipe Page') | ![List Recipe Page](/src/assets/screenshot/menu.jpg?raw=true 'List Recipe Page') |

| Edit Profile Page                                                                    |
| ------------------------------------------------------------------------------------ |
| ![Edit Profile](/src/assets/screenshot/editProfile.jpg?raw=true 'Edit Profile Page') |
...
- [`Food Recipes Demo`](https://recipe-app-client-omega.vercel.app/)
- [`Food Recipes Rest API`](https://determined-pink-foal.cyclic.app)
- [`Food Recipes Frontend Repository`](https://github.com/Ihlassul2023/recipe-app-client)
